...
const routes: Routes = [
  { path: '', redirectTo: 'admin/index', pathMatch: 'full' },
  {
    ...
    children: [
      ...
      { path: 'kullanıcı-listesi', component: EcomCustomersComponent },
      ...
      { path: 'satis-istatistikleri', component: AnalyticsComponent },
      { path: 'events', component: EventsComponent },
      { path: 'siparis-listesi', component: OrderListComponent },
      {
        path: 'cari-listesi',
